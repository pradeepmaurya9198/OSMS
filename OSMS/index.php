     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 1st Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text">I got my Laptop Repair in Just 45 Minutes Best Service, I love it.</p>
       </div>
      </div>
     </div> <!-- End 1st Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 2nd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text"> Best Home Appliences Repairing Service Provider they repair my AC on time.</p>
       </div>
      </div>
     </div> <!-- End 2nd Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 3rd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text">Fastest Services I have seen ever, I love the Speed and Service.</p>
       </div>
      </div>
     </div> <!-- End 3rd Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 4th Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text">Cheapest Service provider in my Location better than my local providers.</p>
       </div>
      </div>
     </div> <!-- End 4th Column -->
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center"> <!-- Start 2nd Column -->
        <strong>Headquarter:</strong><br>
          OSMS pvt Ltd,<br> Mahavir Chhapra, Gorakhpur<br> Uttar Pradesh - 273401<br> Phone: +91 9695437614<br>
          <a href="#" target="_blank">www.osms.com</a><br>
      </div>
      <div>
        <strong>Branch:</strong><br>
          OSMS pvt Ltd,<br> Bhagat Chhauraha, Gorakhpur<br> Uttar Pradesh - 273016<br> Phone: +91 9695437614<br>
          <a href="#" target="_blank">www.osms.com</a><br>    
      </div> <!-- End 2nd Column -->
    </div>
 </div> <!-- End Contact US -->
  ...
  <div class="container">
   <div class="row py-3">
    ...
    <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
     <small>Designed by Pradeep Maurya &copy; 2022</small>
     <small class="ml-2"><a href="Admin/login.php">Admin Login</a></small>
     <small class="ml-2"><a href="techy.php">Technician Area</a></small>
    </div> <!-- End 2nd Column -->
   </div>
  </div>
 </footer>
